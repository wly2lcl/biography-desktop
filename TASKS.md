...
| P2-003 | 国际化 (i18n) 支持 | P2 | ✅ | 4h | src/i18n/ | 已创建 i18n 框架 + 53 个翻译 key + BiographyScreen 迁移 |
| P2-004 | 离线模式首次引导提示 | P2 | ✅ | 1h | StartScreen | 已实现可 dismiss 的首次引导卡片 |
...
| P0 阻塞问题修复 | ~1 天 ✅ |
| P1 建议改进 | ~2 天（8/10 完成） |
| P2 长期优化 | ~2.5 天（5/8 完成） |
| **实际完成** | **约 12-13 天** |
| **剩余工作量** | **约 1-2 天（打包验证 + 4 项 P2 可选）** |
