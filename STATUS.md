...
| 6 | 测试与打包 | 75% | 🔨 TS 测试 81/81 ✅ / Linux 打包 ✅ / Windows⏸️ / macOS⏸️ |
...
| M7: 测试与打包完成 | 2026-06-07 | 2026-06-02 | 🔨 TS 测试 81/81 ✅ / Linux .deb+.rpm ✅ / Windows⏸️ / macOS⏸️ |
...
| 任务总数 | 185 个（含 P0/P1/P2 + 打包） |
| 已完成任务 | 168 个（92%） |
| 待开始任务 | 7 个（4%，仅集成测试 + Windows/macOS 打包） |
| 暂停任务 | 5 个（3%） |
| 取消任务 | 5 个（3%） |
