...
> 最后更新: 2026-07-17（Release 平台签名状态拆分完成，待凭据与远端复验）
...
| **验证结果** | 已拆分 Apple/Windows 平台签名状态；发布元数据组合测试、构建策略、YAML、316 项前端测试、覆盖率及稳定/实验构建通过 |
| **发布状态** | 当前 v0.1.0 为 draft/prerelease；正在拆分 Apple/Windows 平台签名状态，正式发布仍需外部证书与公证验收 |
